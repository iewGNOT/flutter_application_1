    ...
    try {
      ...
      return NativeDatabase.createInBackground(
        ...
        setup: (rawDatabase) {
          ...
          // SQLCipher's PRAGMA key does not support parameterised queries.
          // The key is generated by SecureStorageDatabaseKeyService as a
          // base64url-encoded string, so it only contains [A-Za-z0-9+/=_-].
          // Assert this invariant here to catch any unexpected key format early.
          assert(
            RegExp(r'^[A-Za-z0-9+/=_\-]+$').hasMatch(databaseKey),
            'Database key contains unexpected characters.',
          );
